...
pg.display.set_caption("Пересечение объектов")
...
bg_point = pg.image.load('pygame/images/score_fon.png')
f = pg.font.SysFont('arial', 30)

# скорость движения и парамметры ТЕЛЕГА 
speed = 10
telega = pg.image.load('pygame/images/telega.png')
...
balls_surf = [pg.image.load("pygame/images/"+data['path']).convert_alpha() for data in balls_data]
